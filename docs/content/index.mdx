...
[Any pop-up content that is shown on hover or focus must be easily dismissable (1.4.13 AA)](content-dismissable).
...
[Any pop-up content that is shown on hover must also be hoverable (1.4.13 AA)](pop-up-hoverable).
...
[Any pop-up content that is shown on hover or focus must remain persistent (1.4.13 AA)](pop-up-persistent).
