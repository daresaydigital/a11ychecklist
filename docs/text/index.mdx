...
All of the text and copy on the web page should be adapted to fit the context, be legible, and accessible by every type of user.
...
<CategoryItem id="convey-and-refer">

[Don't rely on text color when conveying and referring to information](convey-and-refer).
