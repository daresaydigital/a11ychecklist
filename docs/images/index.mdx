...
<CategoryItem id="graphical-object-ratio">

[Every graphical object that is needed for the user to understand the content must have a contrast ratio of at least 3:1 against adjacent color(s)](graphical-object-ratio).
